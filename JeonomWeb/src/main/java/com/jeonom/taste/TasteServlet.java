...
public class TasteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html;charset=utf-8"); // 한글 설정 먼저하고
//		PrintWriter out = response.getWriter(); // 스트림 연결
...
//		out.println("좋아하는 동물 : " + petMap.get(pet) + "<br>");
//		out.println("좋아하는 음식 : " + foodStr + "<br>");
//		out.println("</p>");
